...
model = TransformerModel(ninp=88, nhead=8, nhid=3, nlayers=3, nout=88)
...
if __name__ == "__main__":
    best_tr_loss = 1e8
    tr_loss_list = []
    model_name = "jsb_transformer_best_model.pt"
    ...
    plot_losses(train_losses, test_losses, "jsb_transformer_losses.pdf", "Transformer on JSB_Chorales")
    print('-' * 89)
